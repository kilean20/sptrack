...
outfile1=eps/bbeat_$label.eps
outfile2=eps/dquad_$label.eps
outfile3=eps/harms_$label.eps
awk '{ print $3," ",$8," ",$11 }' data/FODO0_$label.twiss > b0
awk '{ print $8," ",$11 }' data/FODO1_$label.twiss > b1
awk '{ print $8," ",$11 }' data/FODO2_$label.twiss > b2
...
set key samplen 2 spacing .85 font ',20'
set output '$outfile1'
...
p 'ball' u (\$1):(100*(\$4-\$2)/\$2) w l lw 3 lt 1 lc 1 t "x-before",\
      ...
      '' u (\$1):(100*(\$6-\$2)/\$2) w l lw 2 lt 3 lc 1 t "x-after",\
      '' u (\$1):(100*(\$7-\$3)/\$3) w l lw 2 lt 3 lc 3 t "z-after"
HERE1

cp data/dqba_$label.dat dquad.dat
cat <<HERE2 | gnuplot
...
cat data/harm_$label.dat > harm.dat
echo >> harm.dat
echo >> harm.dat
cat data/dnxz_$label.dat >> harm.dat
cat <<HERE3 | gnuplot
set term post eps enhanced color font 'Helvetica,28'
set output '$outfile3'
set multiplot
...
set xrange [0:11]
set yrange [0:0.012]
set xtics 1 nomirror out font ",20"

set boxwidth 0.2
#set grid
set key font ",20" at 4.0,0.012
...
unset grid
unset ylabel
set title '{/Symbol D}{/Symbol n}_x / {/Symbol D}{/Symbol n}_z' font ",20" offset 0,-0.9
set ytics font ",16"
unset xtics
unset xlabel
unset key
